    ...
    <div>
        ...
        <div className='my-8 flex flex-col md:flex-row gap-16'>
            ...
            <div className='flex flex-col justify-center gap-6 md:w-1/2 text-gray-600 m-8'>
                ...
                <p className='text-sm'>Since our inception, we've worked tirelessly to curate a diverse selection of high-quality
                ...
                <p className='text-sm'>Our mission at Forever is to empower customers with choice, convenience, and
